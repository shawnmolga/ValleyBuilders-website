...
from .views import HomePageView, KitchenPageView, BathroomPageView, FloorsPageView, ExpandingPageView, DrivewaysPageView, RoofingPageView, WindowsPageView, PaintPageView
